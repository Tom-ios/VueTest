<template>
  <div ref="pageDiv" class="clearfix pageDiv">
    <el-row style="border: 1px solid #EBEEF5;padding:8px 0px;font-size:14px;color:#606266" class="clearfix">
      ...
      <el-button plain size="mini" class="ml-10" @click="resetForm('queryForm')">重置</el-button>
    ...
    <div ref="tablewrap" style="margin-top:15px">
      ...
      >
        ...
        <el-table-column prop="defaultValue" align="center" label="默认模板" width="70">
...
export default {
  name: 'ExpensesCourseListVm',
  props: {
    toExpensesCourseEdit: {
      type: Function,
      default: null
    }
  },
  ...
  methods: {
    ...
    addtemplate() {
      ...
      this.toExpensesCourseEdit()
    },
    handleRowEdit: function(index, row) {
      this.toExpensesCourseEdit(row.id, 'edit')
    ...
    handleCopyRow(index, row) {
      this.toExpensesCourseEdit(row.id, 'copy')
